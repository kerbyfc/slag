...
}).call(this);Backbone.Validation = (function(_){
  'use strict';
...
(function() {
  ...
  Slag = (function(_super) {
    var _ref;

    __extends(Slag, _super);
    ...
    */
    ...
    function Slag() {
      return Slag.__super__.constructor.apply(this, arguments);
    }

    Slag.api = '/api/frontend/v2/';
    ...
    */
    ...
    if ((_ref = Slag.token) == null) {
      Slag.token = $('meta[name="csrf-token"]').attr('content');
    }
    ...
    */
    ...
    Slag.groupLogs = _.isFunction(console.groupCollapsed);
    ...
    */
    ...
    Slag.logMethodCall = function(method, call) {
      if (Slag.lastLogGroup !== method) {
    ...
    */
    ...
    Slag.callback = function(call) {
      var log;
      log = call.scope.audit !== void 0 || Slag.audit === true;
      if (call.caller.match(/trigger$/) != null) {
        call.args[0] = "" + (call.caller.slice(0, -7)) + call.args[0];
        if (log) {
          Slag.logMethodCall("" + call.args[0], call);
        }
        return Slag.trigger.apply(Slag, call.args);
      } else {
        if (log) {
          Slag.logMethodCall(call.caller, call);
        }
        if (_.isObject(call.scope._events) && _.has(call.scope._events, call.method)) {
          Slag.trigger.apply(call.scope, [call.method].concat(call.result));
        }
        return Slag.trigger(call.caller, call.result, call.scope, call.method);
      }
    };
    ...
    */
    ...
    Slag.register = function(module, extentions, target_methods, protected_methods, callback) {
      var cfg, extention;
      if (extentions == null) {
        extentions = {};
      }
      if (target_methods == null) {
        target_methods = /^([^\_])/;
      }
      if (protected_methods == null) {
        protected_methods = false;
      }
      if (callback == null) {
        callback = Slag.callback;
      }
      ...
      return Slag.define(J(module.name, module, extentions, target_methods, protected_methods, callback));
    };
    ...
    */
    ...
    Slag.factory = function() {
      var args, cfg, class_name, module, overrides;
      class_name = arguments[0], overrides = arguments[1], args = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
      if (overrides == null) {
        overrides = {};
      }
      if (!_.has(Slag.classes, class_name)) {
    ...
    */
    ...
    Slag.define = function(module) {
      var type, _name, _ref1;
      type = module.name.match(Slag.entities);
      if ((type != null) && _.last(type) !== module.name) {
        ((_ref1 = Slag[_name = "" + (type.pop()) + "s"]) != null ? _ref1 : Slag[_name] = {})[module.name] = module;
      } else {
    ...
    */
    ...
    Slag.mixin = function(extention, module) {
      var flag, mixin, _ref1;
      if (_.isObject(module.prototype.include)) {
        _ref1 = module.prototype.include;
        for (mixin in _ref1) {
          flag = _ref1[mixin];
          if (flag) {
            _.extend(extention, Slag.Mixins[mixin](module));
          }
        }
      }
      return extention;
    ...
    */
    ...
    Slag.template = J('Slag.template', function() {
      var template, tmp, values;
      template = arguments[0], values = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      return "";
      ...
      if (values.length) {
        return tmp(_.extend.apply(_, values));
      } else {
        return tmp;
      }
    });
    ...
    */
    ...
    Slag.entities = /(Model|View|Widget|Collection|Layout|Content|Brick|Input)$/g;
...
(function() {
  ...
  Slag.register(Utils = (function() {
    ...
    Utils.prototype.duration = function(seconds) {
      var d, h, m, s;
      if (seconds == null) {
        seconds = 0;
      }
    ...
    Utils.prototype.allowedKey = function(keycode) {
      switch (keycode) {
        case 37:
        case 38:
        case 39:
    ...
    Utils.prototype.plural = function(str) {
      if (str.slice(-1) !== 's') {
        str += 's';
      }
      return str;
    ...
    Utils.prototype.singular = function(str) {
      if (str.slice(-1) === 's') {
        str = str.slice(0, -1);
      }
      return str;
...
(function() {
  ...
  Slag.register(Mixins = (function() {
    ...
    */
    ...
    Mixins.el_prop = function(module) {
      return {
        setEl: function(el) {
          var _this = this;
    ...
    */
    ...
    Mixins.has_entity = function(module) {
      return {
        getEntityName: function(from) {
          if (from == null) {
            from = this.constructor.name;
          }
          return from.replace(Slag.entities, '').toLowerCase();
        }
      };
    };
    ...
    */
    ...
    Mixins.url_params = function(module) {
      return {
        params: function(params, pairs) {
          var opt, val;
          if (params == null) {
            params = {};
          }
          ...
          if (_.isArray(params)) {
            ...
            for (opt in params) {
              val = params[opt];
              pairs.push(val != null ? "" + opt + "=" + val : opt);
            }
            return pairs.join('&');
          } else {
            return params;
      ...
      return {
        ...
        */
        ...
        loading: function(el, state) {
          ...
          if (state == null) {
            return this.loadingStates[el];
          } else {
            mask = $(el).hasClass('loadmask') ? $(el) : !$(el).find('.loadmask').length ? $("<div class='loadmask'></div>").appendTo(el) : $(el).find('.loadmask');
            if (state) {
              if (this.loadmask_css != null) {
                mask.css(this.loadmask_css);
              }
              mask.show();
            } else {
              mask.hide();
            }
            return this.loadingStates[el] = state;
          }
        }
      };
    };
    ...
    Mixins.sheduler = function() {
      return {
        ...
        invoke: function() {
          var call,
            _this = this;
          if (!this.processing_queue && (call = this.queue.shift())) {
            this.processing_queue = call;
            this[call.method].apply(call.scope, call.args);
          }
          return this.task_timeout = setTimeout(function() {
        ...
        resolve: function(result) {
          ...
          if (this.processing_queue) {
            method = this.processing_queue.method;
            this.processing_queue = false;
            clearTimeout(this.task_timeout);
            this.task_timeout = null;
            this.invoke();
          }
          if (method) {
            this.trigger("resolve:" + method, result, this);
          }
          return result;
        }
      };
...
(function() {
  ...
  Slag.register(Navigator = (function(_super) {
    ...
    function Navigator() {
      ...
      return Navigator.__super__.constructor.apply(this, arguments);
    }

    Navigator.prototype.el = '.navbar-fixed-top .navigator';

    Navigator.prototype.breadcrumbs = '#breadcrumbs > ul';

    Navigator.prototype.include = {
      el_prop: true,
      events: true
    };

    Navigator.prototype.current = null;
    ...
    */
    ...
    Navigator.prototype.initialize = function() {
      ...
      Navigator.__super__.initialize.apply(this, arguments);
      _.defer(function() {
        var entity, item, name, _i, _len, _ref, _ref1;
        _ref = ['layout', 'view'];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          entity = _ref[_i];
          _ref1 = Slag["" + (app.utils.capitalize(entity)) + "s"];
          for (name in _ref1) {
            item = _ref1[name];
            _this.register(entity, item);
          }
        }
        _this.on('route', _this.updateMenu);
        _this.on('route', _this.scrollTop);
    ...
    */
    ...
    Navigator.prototype.register = function(type, item, route, title, icon) {
      var data, el, _ref, _ref1;
      if (route == null) {
        route = null;
      }
      if (title == null) {
      ...
      el = null;
      data = {
        title: title || item.prototype.menu_title,
        icon: icon || item.prototype.menu_icon,
        layout: item.prototype.layout,
        selector: item.name
      };
      if (type === 'layout') {
        if (item.prototype.menu_title) {
          el = $(Slag.template('menu/layout', data));
          this.$el.append(el);
        }
      } else {
        if (item.prototype.route) {
          route = item.prototype.route;
        }
        if (route != null) {
          data.url = "#" + this.removeOptionalParts(route);
          this.route(route, {
            name: item.name,
            state: this.extractStaticArgs(route)
          });
          data.route = _.first(Backbone.history.handlers).route;
          el = $(Slag.template('menu/view', data));
          if (item.prototype.layout) {
            this.$el.find("." + item.prototype.layout + " > ul").append(el);
          } else {
            this.$el.append(el);
          }
        } else if (item.prototype.routes) {
          _ref = item.prototype.routes;
          for (route in _ref) {
            title = _ref[route];
            this.register('view', item, route, title, (_ref1 = item.prototype.menu_icons) != null ? _ref1[title] : void 0);
          }
          return null;
        }
      }
    ...
    */
    ...
    Navigator.prototype.stringifyRoute = function(route) {
      return this.removeOptionalParts(route).replace(/\//g, '-').replace(/[^\w|-]/g, '');
    };

    Navigator.prototype.url = function() {
    ...
    */
    ...
    Navigator.prototype.removeOptionalParts = function(route, i) {
      if (i == null) {
        i = route.indexOf('(/:');
      }
      if (i < 0) {
    ...
    Navigator.prototype.extractStaticArgs = function(route) {
      return (route.match(/(\/)+([\w\_]+)/g) || []).join().substr(1).split('/');
    };

    Navigator.prototype.scrollTop = function() {
    ...
    */
    ...
    Navigator.prototype.updateMenu = function(view, params) {
      var el, layout, name, viewClass;
      this.current = null;
      this.$('.active').removeClass('active');
      this.breadcrumbs.empty();
      this.appendBreadcrumb('Slag', '#', {
        icon: 'glass'
      });
      if (viewClass = Slag.Views[view.name]) {
        if (viewClass.prototype.highlight) {
          el = this.$(" > ." + viewClass.prototype.highlight).addClass('active');
          this.appendBreadcrumb(_.extend(el.data(), {
            active: true
          }));
        } else {
          layout = viewClass.prototype.layout;
          name = _.isObject(layout) ? layout.constructor.name : _.isString(layout) ? layout : viewClass.name;
          if (name === 'IndexLayout') {
            name = viewClass.name;
          }
          if (name) {
            viewClass = this.$(" > ." + name).addClass('active');
          }
          this.updateBreadcrumbs(viewClass);
          if (this.current != null) {
            this.title(this.current.title, this.current.icon);
          }
        }
      }
      return [view, params];
    ...
    Navigator.prototype.updateBreadcrumbs = function(view, options) {
      var li, _i, _len, _ref, _ref1, _results;
      if (options == null) {
        options = {};
      }
      if (view.hasClass('dropdown')) {
        this.appendBreadcrumb(_.extend(view.data(), {
          active: true
        }));
        _ref = view.find('li');
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          li = _ref[_i];
          _results.push(this.updateBreadcrumbs($(li)));
        }
        return _results;
      } else {
        if (_.isObject(view.data())) {
          if ((_ref1 = view.data('route')) != null ? _ref1.test(this.url()) : void 0) {
            this.current = view.data();
            view.addClass('active');
          }
          return this.appendBreadcrumb(_.extend(view.data(), {
            active: view.hasClass('active')
          }));
        }
      }
    };

    Navigator.prototype.appendBreadcrumb = function() {
      return this.breadcrumbs.append(this.makeBreadcrumb.apply(this, arguments));
    };

    Navigator.prototype.makeBreadcrumb = function(title, url, options) {
      var data, el;
      if (url == null) {
        url = '';
      }
    ...
    Navigator.prototype.title = function(title, icon, slice) {
      var breadcrumb, last, _i, _len, _ref;
      if (icon == null) {
        icon = '';
      }
      if (slice == null) {
      ...
      $('.title').html(Slag.template('menu/title', {
        title: title,
        icon: icon
      }));
      if (slice != null) {
        _ref = this.breadcrumbs.children().slice(slice);
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          breadcrumb = _ref[_i];
          $(breadcrumb).remove();
        }
      }
      last = this.breadcrumbs.find('li:last-child');
      if (!last.data('separator')) {
        last.remove();
      }
      return this.appendBreadcrumb({
        title: title,
        separator: false,
        active: true,
        icon: icon,
...
(function() {
  ...
  Slag.register(Notifier = (function() {

    Notifier.prototype.stack = {
      info: [],
      success: [],
      error: []
    };

    Notifier.prototype.queue = {};

    Notifier.prototype.timeout = 300;

    Notifier.prototype.info = humane.spawn({
      addnCls: 'humane-jackedup-info',
      timeout: 3000
    });

    Notifier.prototype.success = humane.spawn({
      addnCls: 'humane-jackedup-success',
      timeout: 2000
    });

    Notifier.prototype.error = humane.spawn({
    ...
    function Notifier() {
      var _this = this;
      Slag.on('App.info App.error App.success', function(args, app, method) {
        var msg;
        msg = _.first(args);
        if (_this.isValid(msg)) {
          return _this.shedule(method, msg);
        }
      });
    }

    Notifier.prototype.isValid = function(msg) {
      return msg.toString();
    };

    Notifier.prototype.shedule = function(method, msg) {
      var _this = this;
      this.fill(method, msg);
      this.cleanup(method);
      return this.queue[method] = setTimeout(function() {
        return _this.invoke(method);
      }, this.timeout);
    };

    Notifier.prototype.cleanup = function(method) {
      if (this.queue[method] != null) {
        clearTimeout(this.queue[method]);
        return this.queue[method] = null;
      }
    };

    Notifier.prototype.inc = function(method, index) {
      var msg, times;
      msg = this.stack[method][index];
      times = msg.match(/[\d]+[\s]+times/i);
      return this.stack[method][index] = times != null ? msg.slice(0, _.indexOf(msg, times.index)) + (1 + parseInt(times[0])) + " times" : msg + " 2 times";
    };

    Notifier.prototype.fill = function(method, msg) {
      var exists;
      exists = _.indexOf(msg, this.stack[method]);
      if (exists >= 0) {
        return this.inc(method, exists);
      } else {
        return this.stack[method].push(msg);
      }
    };

    Notifier.prototype.invoke = function(method) {
      console.log(" >> ", method, this.stack[method]);
      if (this.stack[method].length) {
        this[method](this.stack[method]);
      }
...
(function() {
  ...
  Slag.register(Presenter = (function(_super) {

    __extends(Presenter, _super);

    Presenter.prototype.el = '#layout-holders';

    Presenter.prototype.include = {
      el_prop: true,
      events: true
    };
    ...
    */
    ...
    Presenter.prototype.Layouts = {};

    Presenter.prototype.layouts = {};

    Presenter.prototype.Views = {};

    Presenter.prototype.views = {};

    Presenter.prototype.current = {
      layout: null,
      view: null
    };
    ...
    */
    ...
    function Presenter() {
      ...
      var _this = this;
      this.setEl();
      Slag.on('Navigator.register', this.register);
      Slag.on('Navigator.updateMenu', function(params) {
        return _this.present.apply(_this, params);
      });
    ...
    Presenter.prototype.register = function(item) {
      if (item != null) {
        return this[app.utils.capitalize(item.type) + 's'][item["class"].name] = item["class"];
      }
    };

    Presenter.prototype.present = function(view, args) {
      var argv, key, layout, viewInstance;
      if (args == null) {
        args = [];
      }
      ...
      viewInstance = !this.views[key] ? this.initView(view.name, key, _.clone(argv)) : this.views[key];
      layout = viewInstance.layout;
      if (!(this.current.layout != null) || this.current.layout.cid !== layout.cid) {
        if (this.current.layout != null) {
          this.current.layout.close();
          this.current.layout.$el.hide();
        }
        if (layout != null) {
          this.current.layout = layout;
          layout.open.apply(layout, _.clone(argv));
        }
      }
      if (layout != null) {
        layout.$el.show();
      }
      if ((this.current.view != null) && this.current.view.cid !== view.cid) {
        this.current.view.close();
        this.current.view.visible = false;
        this.current.view.$el.hide();
      }
      if (viewInstance) {
        this.current.view = viewInstance;
        this.current.view.visible = true;
        viewInstance.$el.show();
        return viewInstance.open.apply(viewInstance, argv);
      }
    };

    Presenter.prototype.embedLayout = function(layout) {
      return this.$el.append("<div class='layout-holder span12 " + layout.name + "-layout'></div>");
    };

    Presenter.prototype.embedView = function(layout, key) {
      return this.$("." + layout + "-layout .view-holders").append("<div class='view-holder " + key + "-view'></div>");
    };

    Presenter.prototype.initView = function(viewName, key, args) {
      var layout, view;
      args = _.clone(args);
      ...
      layout = view.prototype.layout;
      if (!view.prototype.layout) {
        view.prototype.layout = layout = 'IndexLayout';
      }
      ...
      if (_.isFunction(layout)) {
        this.embedLayout(layout);
        layout = this.layouts[layout.name] = view.prototype.layout = new layout;
      }
      this.embedView(layout.constructor.name, key);
      args.unshift("." + key + "-view");
      view = this.views[key] = (function(func, args, ctor) {
        ctor.prototype = func.prototype;
        var child = new ctor, result = func.apply(child, args), t = typeof result;
        return t == "object" || t == "function" ? result || child : child;
      })(view, args, function(){});
    ...
    Presenter.prototype.fixContainerHeight = function() {
      $(window.document).on('resize', function(e) {
        return $('#main').css({
          height: $(window).height()
        });
      });
      return $(window.document).triggerHandler('resize');
    };
...
(function() {
  ...
  Slag.register(Storage = (function() {

    function Storage() {}

    Storage.prototype.listeners = [];

    Storage.prototype.listeners_count = 3;

    Storage.prototype.collections = {};

    Storage.prototype.obtaining_methods = {
      number: 'getById',
      array: 'getByIds',
      object: 'getWhere',
    ...
    */
    ...
    Storage.prototype.get = function(name, param, options) {
      var callbacks, collection, obtaining_method, params, type;
      if (param == null) {
        param = null;
      }
      if (options == null) {
      ...
      callbacks = _.defaults(callbacks, this.callbacks);
      params = [options, callbacks.done, callbacks.fail];
      if (collection = this.getCollection(name, options)) {
        if (param == null) {
          return collection;
        }
        if (_.isString(param) && param.match(/^\d+$/)) {
        ...
        if (_.isString(param)) {
          ...
          obtaining_method = this.obtaining_methods[type];
          params.unshift(param);
        }
        if (!obtaining_method) {
          throw new Error("Wrong second parameter type. Only " + (_.map(_.keys(this.obtaining_methods), function(i) {
            return app.utils.capitalize(i);
          }).join(', ')) + " are supported. " + (app.utils.capitalize(type)) + " given");
        }
        if (!this[obtaining_method]) {
          throw new Error("Storage hasn't `" + obtaining_method + "` obtaining method. Check arguments.");
        }
        params.unshift(collection);
        return this[obtaining_method].apply(this, params);
      }
    };

    Storage.prototype.getByIds = function(collection, ids, options, done, fail) {
      var available, dfd, params;
      if (done == null) {
        done = null;
      }
      if (fail == null) {
      ...
      available = collection.filter(function(m) {
        var _ref;
        return _ref = m.id, __indexOf.call(ids, _ref) >= 0;
      });
      ids = _.difference(ids, _.pluck(available, 'id'));
      if (ids.length) {
        params = ['all=true'].concat(_.map(ids, function(id) {
          return "ids[]=" + id;
        }));
        options = _.extend({}, options, {
          success: function() {
            var loaded;
            loaded = collection.filter(function(m) {
              var _ref;
              return _ref = m.id, __indexOf.call(ids, _ref) >= 0;
            });
            return typeof done === "function" ? done(_.union(available, loaded)) : void 0;
          },
          error: fail
        });
        return dfd = collection.fetch(params, options);
      } else {
    ...
    Storage.prototype.getById = function(collection, id, options, done, fail) {
      var obj;
      if (done == null) {
        done = null;
      }
      ...
      if (obj !== void 0) {
        ...
        obj = collection.fetch("ids[]=" + id, {
          out_of_stock: false,
          success: function() {
            return typeof done === "function" ? done(collection.get(id)) : void 0;
          },
          error: fail
        });
        return obj;
    ...
    Storage.prototype.more = function(collection, options, done, fail) {
      var req;
      if (done == null) {
        done = null;
      }
      ...
      options = _.extend({}, options, {
        success: function() {
          return typeof done === "function" ? done(collection.getModels()) : void 0;
        },
        error: fail
      });
      return req = collection.more(options);
    };

    Storage.prototype.getWhere = function(collection, condition) {
      if (condition == null) {
        condition = {};
      }
    ...
    Storage.prototype.getFilteredBy = function(collection, filter) {
      return collection.filter(filter);
    };

    Storage.prototype.find = function(collection, filter) {
      return this.getCollection(collection).find(filter);
    };

    Storage.prototype.getCollection = function(selector, options) {
      var collection, entity, key, partial;
      if (options == null) {
        options = {};
      }
      options = _.clone(options);
      partial = selector.indexOf('(');
      entity = partial > 0 ? selector.slice(0, partial) : (partial = -2, selector);
      entity = app.utils.capitalize(app.utils.plural(entity));
      key = partial > 0 ? "partial:" + selector : entity;
      collection = (function() {
        var _ref;
        if (!this.collections[key]) {
          if (!_.has(Slag.Collections, "" + entity + "Collection")) {
          ...
          if (partial > 0) {
            options.common = this.getCollection(entity);
          }
          if ((_ref = options.url) == null) {
            options.url = app.api + options.root + selector.slice(++partial, -1);
          }
          return this.collections[key] = new Slag.Collections["" + entity + "Collection"](options).setModel();
        } else {
    ...
    Storage.prototype.factory = function() {
      var args, collection, entity, model, plural, singular;
      ...
      if (!_.has(Slag.Collections, "" + plural + "Collection")) {
        collection = Slag.factory("Collection", {
          fname: plural + 'Collection'
        });
      }
      if (!_.has(Slag.Models, "" + singular + "Model")) {
        model = Slag.factory("Model", {
          fname: singular + 'Model'
        });
      }
      args.unshift(plural);
      if (!(args.length > 1)) {
        return this.getCollection.apply(this, args);
      } else {
...
(function() {
  ...
  Slag.register(Initer = (function() {
    /**
     * Корневой путь апи
     * @type {String}
    */

    Initer.prototype.api = Slag.api || "/api/frontend/v2/";

    Initer.prototype.ua = window.navigator.userAgent;
    ...
    */
    ...
    Initer.prototype.isMobile = function() {
      return /android.+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(this.ua || /1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|e\-|e\/|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(di|rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|xda(\-|2|g)|yas\-|your|zeto|zte\-/i.test(this.ua.substr(0, 4)));
    };
    ...
    */
    ...
    Initer.prototype.initPreviewLabels = function() {
      if (!this.isMobile()) {
        $(document.body).on('mouseover', '.content-preview .label > a', function() {
          return $(this).parent().addClass('expanded');
        });
        return $(document.body).on('mouseout', '.content-preview > .label > a', function() {
    ...
    */
    ...
    Initer.prototype.regModules = function() {
      var _this = this;
      _.defer(function() {
        var module, _i, _len, _ref, _results;
        _ref = ['Utils', 'Storage', 'Notifier', 'Presenter', 'Navigator'];
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          module = _ref[_i];
          _results.push(_this.registerModule(module));
        }
        return _results;
      });
      return this;
    ...
    */
    ...
    Initer.prototype.checkEnvironment = function() {
      return true;
    };
    ...
    */
    ...
    Initer.prototype.setupToken = function() {
      return jQuery.ajaxSetup({
        beforeSend: function(xhr) {
          return xhr.setRequestHeader('X-CSRF-Token', Slag.token);
        }
      });
    };
    ...
    */
    ...
    Initer.prototype.registerModule = function(module) {
      return this[module.toLowerCase()] = new Slag[module];
    };

    Initer.prototype.info = function() {
      return arguments;
    };

    Initer.prototype.error = function() {
      return arguments;
    };

    Initer.prototype.success = function() {
      return arguments;
    };

    Initer.prototype.log = function() {
      if (Slag.groupLogs) {
        console.groupEnd();
      }
  ...
  $(function() {
    var app;
    return app = window.app = new Slag.Initer;
  });
...
(function() {
  ...
  Slag.register(Model = (function(_super) {

    __extends(Model, _super);

    Model.prototype.include = {
      events: true,
      has_entity: true,
      url_params: true
    };
    ...
    function Model(attrs, options) {
      ...
      this.on422 = __bind(this.on422, this);

      this.on404 = __bind(this.on404, this);

      this.onError = __bind(this.onError, this);

      this._onApiError = __bind(this._onApiError, this);

      this.related = __bind(this.related, this);
      ...
      if ((_ref = this.root) == null) {
        this.root = this.getEntityName();
      }
      if (_.has(options, 'url')) {
        delete options.url;
      }
      Model.__super__.constructor.call(this, attrs, _.extend({}, options, {
        silent: true
      }));
      this.options.base_url = app.api + this.root + 's';
      this.on('error', this.onError);
      this.on('invalid', this.onInvalid);
    }

    Model.prototype.parse = function(res, options) {
      if (res[this.root] != null) {
        res = res[this.root];
      }
      return res;
    };

    Model.prototype.url = function(params, url) {
      if (url == null) {
    ...
    Model.prototype.save = function(options, opts) {
      var attrs;
      if (options == null) {
        options = null;
      }
      ...
      if (!options.url) {
        options.url = this.url(options.params);
      }
      _.extend(options, this.callbacks(options));
      return Model.__super__.save.call(this, attrs, options);
    };

    Model.prototype.get = function(path, obj) {
      if (obj == null) {
        obj = null;
      }
      ...
      obj = obj == null ? Backbone.Model.prototype.get.call(this, path.shift()) : obj[path.shift()];
      if (path.length) {
    ...
    Model.prototype.setByPath = function(path, val, options) {
      var holder, last, num, parent, root, target;
      if (path.length) {
        if (_.isString(path)) {
          path = path.split(".");
        }
        target = this.get(path.slice(0, -1));
        if (_.isUndefined(target) && (parent = _.clone(path).slice(0, -1)) && parent.length) {
          last = _.last(parent);
          num = parseInt(path.slice(-1));
          holder = _.isNaN(num) || num < 0 ? {} : [];
          if (parent.length === 1) {
            root = this.get(last);
            if (root === void 0) {
              Backbone.Model.prototype.set.call(this, last, holder, {
                silent: true
              });
            }
            target = this.get(last);
          } else {
            this.setByPath(parent, holder, options);
            target = this.get(parent);
          }
        }
        if (_.isArray(target) || _.isObject(target)) {
          target[path.slice(-1)] = val;
          this.trigger("change:" + (path.join('.')), this, val, options);
        } else {
          throw new Error("Cant set property " + path + " of " + this.constructor.name);
        }
      }
      return this;
    };

    Model.prototype.path = function(parent, child) {
      if (parent.length) {
        return "" + parent + "." + child;
      } else {
        return child;
    ...
    Model.prototype.map = function(obj, max_depth, depth, parent, bk) {
      var key, val;
      if (obj == null) {
        obj = this.toJSON();
      }
      ...
      for (key in obj) {
        val = obj[key];
        key = this.path(parent, key);
        bk = (_.isObject(val) || _.isArray(val)) && depth < max_depth ? _.union(bk, this.map(val, max_depth, ++depth, key)) : bk;
        bk.push(key);
      }
      return bk;
    };

    Model.prototype.toHASH = function(obj, depth, hash) {
    ...
    Model.prototype.set = function(key, val, options) {
      ...
      return this.change(key, val, options);
    };

    Model.prototype.change = function(key, val, options, attrs) {
      var dot, root, roots, _i, _len, _ref;
      if (val == null) {
        val = {};
      }
      if (options == null) {
      ...
      for (key in attrs) {
        val = attrs[key];
        if (!((dot = _.indexOf(key, '.')) && dot >= 0)) {
          continue;
        }
        delete attrs[key];
        this.setByPath(key, val, options);
      ...
      if (!options.silent) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          root = _ref[_i];
          this.trigger("change:" + root, this, this.get(root), options);
        }
      }
    ...
    Model.prototype.unset = function(attr, options) {
      return Backbone.Model.prototype.set.call(this, attr, void 0, _.extend({}, options, {
        unset: true
      }));
    };

    Model.prototype.callbacks = function(options, callbacks) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        type = _ref[_i];
        _results.push(this["" + type + "Callback"](options[type] || null, options));
      }
      return _results;
    };

    Model.prototype.related = function(entities, done, fail) {
      var entity, promises, prop, _i, _len,
        _this = this;
      promises = [];
      ...
      for (_i = 0, _len = entities.length; _i < _len; _i++) {
        entity = entities[_i];
        if (!(prop = this.mapping[entity] || this.mapping[app.utils.plural(entity)])) {
          prop = app.utils.singular(entity) + "_ids";
        }
        promises.push(app.storage.get(entity, this.get(prop)));
      }
      $.when.apply($, promises).then(function(models) {
        return typeof done === "function" ? done.apply(null, arguments) : void 0;
      }, fail);
      return _.flatten(promises);
    };

    Model.prototype.successCallback = function(callback, options) {
      return J(function(model, attrs, req) {
        var _this = this;
        app.success("Данные " + model.constructor.name + " сохранены");
        if (options.include) {
          return this.related(include, function() {
            return typeof callback === "function" ? callback(model, attrs, req) : void 0;
          });
        } else {
          return typeof callback === "function" ? callback(model, attrs, req) : void 0;
        }
    ...
    Model.prototype.errorCallback = function(callback, options) {
      return J(function(model, attrs, req) {
    ...
    Model.prototype._onApiError = function(res) {
      return app.error(Error("Ошибка сервера: " + (res.responseText.slice(0, 120)) + "... Обратитесь к разработчикам"));
    };

    Model.prototype.onError = function(model, res) {
      var _name;
      if (this["on" + res.status] == null) {
        this._onApiError(res);
      }
      return typeof this[_name = "on" + res.status] === "function" ? this[_name](res) : void 0;
    };

    Model.prototype.on404 = function(res) {
      if (res.responseText === "{}") {
        return app.info("Данные " + this.constructor.name + " не найдены по идентификатору");
      }
    };

    Model.prototype.on422 = function(res) {
      var err, errors, i, _results;
      console.log("HERE");
      ...
      for (i in errors) {
        err = errors[i];
        _results.push(app.error("Модель " + this.constructor.name + ": " + i + " " + err));
      }
      return _results;
    };
...
(function() {
  ...
  Slag.register(Collection = (function(_super) {

    __extends(Collection, _super);

    Collection.prototype.include = {
      has_entity: true,
      events: true,
      url_params: true
    };
    ...
    Collection.prototype.overrides = {};
    ...
    function Collection(options) {
      ...
      if (!_.isString(options.url)) {
        options.url = app.api + this.getEntityName();
      }
      this.options = _.defaults(options, _.extend({}, this.defaults, this.overrides));
      if (this.isPartial()) {
        this.models = this.options.common.models;
        this._byId = this.options.common._byId;
      }
    }

    Collection.prototype.isPartial = function() {
      return this.options.common !== false;
    };
    ...
    Collection.prototype.setModel = function(model) {
      ...
      if (!_.has(Slag.Models, model)) {
        throw new Error("Implied that the " + (this.getEntityName()) + "Collection will be used with " + model + ", which is not exists");
      }
      this.model = Slag.Models[model];
      return this;
    };

    Collection.prototype.parse = function(res, options) {
      options = _.clone(options);
      this.options.meta = res.meta || false;
      if (!this.options.meta) {
        this.isFгllyLoaded = true;
      }
      if (res[this.options.root]) {
        res = res[this.options.root];
      }
      return res;
    };

    Collection.prototype.url = function(params, options) {
      var affixes, ids, url,
        _this = this;
      if (params == null) {
        params = {};
      ...
      url = options.url;
      if (_(params).size()) {
        affixes.push(this.params(params));
      }
      if (options.all) {
        affixes.push('all=true');
      }
      if (options.out_of_stock && !(affixes.join('').match(/ids\[\]\=/) != null)) {
        if (ids = (_.map(this.pluck('id'), function(id) {
          return "not_ids[]=" + id;
        })).join('&')) {
          affixes.push(ids);
        }
      ...
      if (affixes.length) {
        url += (url.match(/\?/) != null ? '&' : '?') + affixes.join('&');
      }
      return url;
    };
    ...
    Collection.prototype.fetch = function(params, options) {
      ...
      options = _.defaults(options, {
        ...
        silent: false,
        all: false,
        out_of_stock: this.options.out_of_stock
      });
      options.url = this.url(params, options);
      if (options.include) {
        success = options.success;
        options.success = function(_this, models) {
          return _this.related(options.include, _this.parse(models), {
            done: success,
            fail: options.error
          });
        };
    ...
    Collection.prototype.related = function(entity, from, options) {
      var ids, prop;
      if (options == null) {
        options = {};
      }
      ...
      prop = app.utils.singular(entity) + '_ids';
      ids = _.flatten(_.map(from, function(m) {
        return m[prop] || (typeof m.get === "function" ? m.get(prop) : void 0);
      }));
      return app.storage.get(entity, _.uniq(ids), options);
    };

    Collection.prototype.isFullyLoaded = function() {
      if (this.options.meta) {
        return this.options.meta.total_page <= this.pages.length;
      }
      return false;
    };

    Collection.prototype.getModels = function(options) {
      var models;
      if (options == null) {
        options = {};
      }
      models = this.isPartial() && (this.options.condition != null) ? this.filter(this.options.condition) : this.models;
      if (options._) {
        return _(models);
      } else {
        return models;
    ...
    Collection.prototype.isOwn = function(model, id) {
      if (id == null) {
        id = model.id || model;
      }
      if (!this.isPartial()) {
        return true;
      } else if ((this.own != null) && _.has(this.own, id)) {
        return true;
      } else if ((this.options.condition != null) && this.options.condition(model)) {
        return true;
      } else {
        return false;
      }
    ...
    Collection.prototype.more = function(options, params) {
      if (options == null) {
        options = {};
      }
      if (params == null) {
      ...
      if (this.options.meta && this.pages.length < this.options.meta.total_page) {
        this.options.meta.current_page = this.options.out_of_stock ? 1 : Math.max(this.pages) < this.options.meta.current_page ? Math.max(this.pages) + 1 : Math.min(this.pages) > 1 ? Math.min(this.pages) - 1 : this.options.meta.current_page + 1;
        this.pages = _.union(this.pages, this.options.meta.current_page);
        params = _.extend({
    ...
    Collection.prototype.create = function(model, options) {
      ...
      return model.save(null, options).promise();
    };
...
(function() {
  ...
  Slag.register(Layout = (function(_super) {
    ...
    */
    ...
    Layout.prototype.menu_title = false;

    Layout.prototype.include = {
      el_prop: true,
      events: true,
      loader: true
    };
    ...
    */
    ...
    Layout.prototype.open = function() {
      return false;
    };
    ...
    function Layout() {
      this.setEl("." + this.constructor.name + "-layout");
    ...
    Layout.prototype.render = function(data) {
      ...
      this.undelegateEvents();
      this.$el.html(Slag.template('layouts/' + this.constructor.name.replace(/Layout$/, '').toLowerCase(), data));
      this.delegateEvents();
      return this;
    };
...
(function() {
  ...
  Slag.register(View = (function(_super) {
    ...
    View.prototype.layout = false;

    View.prototype.menu_title = false;

    View.prototype.include = {
      el_prop: true,
      events: true,
      loader: true
    };
    ...
    View.prototype.title = function(html) {
      return app.navigator.title(html);
    };
    ...
    View.prototype.initialize = function(el) {
    ...
    View.prototype.render = function(data) {
      ...
      this.$el.html(Slag.template('views/' + this.constructor.name.replace(/View$/, '').toLowerCase(), data));
      this.trigger('render');
      return this;
    };
...
(function() {
  ...
  Slag.register(Widget = (function(_super) {

    __extends(Widget, _super);

    Widget.prototype.include = {
      events: true,
      el_prop: true
    };
...
(function() {
  ...
  Slag.register(Input = (function(_super) {

    __extends(Input, _super);

    function Input(el, model, attr) {
      var _this = this;
      this.model = model;
      this.attr = attr;
    ...
    Input.prototype.val = function(value) {
      return this["" + (!value ? 'get' : 'set') + "Value"](value);
    };
    ...
    Input.prototype.checkAvailability = function() {
      return true;
    };
...
(function() {
  ...
  Slag.register(ContentModel = (function(_super) {

    __extends(ContentModel, _super);

    function ContentModel(attrs, options) {
      var type;
      if (attrs == null) {
        attrs = {};
      }
...
(function() {
  ...
  Slag.register(PlaylistModel = (function(_super) {
    ...
    PlaylistModel.prototype.mappings = function() {
      return {
        content_ids: 'contents'
      };
    };

    PlaylistModel.prototype.contentsCount = function() {
      return (this.get('content_ids') || []).length;
    };

    PlaylistModel.prototype.title = function() {
      if (!this.id) {
        return 'Новый плейлист';
      }
      return this.get('title') || ("Плейлист №" + this.id);
    };

    PlaylistModel.prototype.duration = function() {
      return _.reduce(this.related('content'), function(memo, m) {
        return memo += m.get('duration') || 0;
      }, 0);
    };

    PlaylistModel.prototype.humanizeDuration = function() {
      return Slag.Content.prototype.humanizeDuration.call(this, this.duration());
    };

    PlaylistModel.prototype.getContentsPreview = function() {
      var badgets;
      badgets = _.map(this.related('content'), function(m) {
        var data;
        data = _.pick(m, 'badge', 'icon');
        data.title = m.humanizeDuration() + " | " + (_.escape(m.get('attrs.brick_description')) || m.title);
        return Slag.template('widgets/content_badge', data);
      });
      return badgets.join('');
    };
...
(function() {
  ...
  Slag.register(QuotationModel = (function(_super) {

    __extends(QuotationModel, _super);

    function QuotationModel() {
      return QuotationModel.__super__.constructor.apply(this, arguments);
    }
...
(function() {
  ...
  Slag.register(IndexLayout = (function(_super) {

    __extends(IndexLayout, _super);

    function IndexLayout() {
      return IndexLayout.__super__.constructor.apply(this, arguments);
    }

    IndexLayout.prototype.events = {
      'click .brand': 'navigate'
    };
...
(function() {
  ...
  Slag.register(PlaylistLayout = (function(_super) {

    __extends(PlaylistLayout, _super);

    function PlaylistLayout() {
      return PlaylistLayout.__super__.constructor.apply(this, arguments);
    }

    PlaylistLayout.prototype.initialize = function() {
      return PlaylistLayout.__super__.initialize.apply(this, arguments);
    };
...
(function() {
  ...
  Slag.register(PlaylistsLayout = (function(_super) {

    __extends(PlaylistsLayout, _super);
    ...
    function PlaylistsLayout() {
      ...
      this.unselectTags = __bind(this.unselectTags, this);
      ...
      this.validateTag = __bind(this.validateTag, this);
      return PlaylistsLayout.__super__.constructor.apply(this, arguments);
    }

    PlaylistsLayout.prototype.menu_title = 'Плейлисты';

    PlaylistsLayout.prototype.menu_icon = 'list';

    PlaylistsLayout.prototype.events = {
    ...
    */
    ...
    PlaylistsLayout.prototype.initialize = function() {
      var id, tags, title;
      this.render();
      this.contents = new Slag.Widgets.ContentTypesWidget(this.$('.content-types-holder'));
      this.search = this.$('.playlists-search');
      this.search.tagsManager({
        validator: this.validateTag,
        backspace: false,
        tagsContainer: '.search-history'
      });
      Slag.on('PlaylistsCollectionWidget.render', this.updateTag);
      $.cookie.json = true;
      if (tags = $.cookie('pls-tags')) {
        for (id in tags) {
          title = tags[id];
          this.search.tagsManager('pushTag', this.formTagBody(id, title));
        }
      }
      return this;
    };
    ...
    */
    ...
    PlaylistsLayout.prototype.validateTag = function(query) {
      if (!query) {
        return false;
      }
      if (query.match(/href/) != null) {
        return true;
      } else {
        app.navigator.navigate(this.url(query), true);
        return false;
      }
    };
    ...
    */
    ...
    PlaylistsLayout.prototype.url = function(idOrFilter) {
      if (idOrFilter.indexOf('-') < 0) {
        return "" + (app.navigator.url().split('/').slice(0, 2).concat(decodeURIComponent(idOrFilter)).join('/'));
      } else {
        return "playlists/" + (decodeURIComponent(idOrFilter).replace('-', '/'));
      }
    };
    ...
    */
    ...
    PlaylistsLayout.prototype.pushTag = function(filter, id) {
      var val;
      if (id == null) {
        id = null;
      }
      ...
      if (id == null) {
        if (val = this.search.val()) {
          app.navigator.navigate(this.url(val), true);
        }
      } else {
        app.log(id, filter);
        if (this.rememberTag(id, filter)) {
          this.search.tagsManager('pushTag', this.formTagBody(id, filter));
        }
      }
      return this;
    };
    ...
    */
    ...
    PlaylistsLayout.prototype.getTag = function(id) {
      return this.$(".scrumb-id-" + id).closest('.tm-tag');
    };
    ...
    */
    ...
    PlaylistsLayout.prototype.formTagBody = function(id, filter) {
      return Slag.template('search/tag', {
        filter: filter,
        id: id,
        url: this.url(id)
      });
    ...
    */
    ...
    PlaylistsLayout.prototype.rememberTag = function(id, filter) {
      var tags;
    ...
    */
    ...
    PlaylistsLayout.prototype.forgеtTag = function(id) {
    ...
    */
    ...
    PlaylistsLayout.prototype.updateTag = function(models, widget) {
      if (_.isArray(models)) {
        return this.getTag(widget.id).find('.m_count').text(models.length);
      }
    };
    ...
    */
    ...
    PlaylistsLayout.prototype.unselectTags = function() {
      return this.$('.tm-tag-success').removeClass('tm-tag-success tm-tag-success').addClass('tm-tag-info');
    };
    ...
    */
    ...
    PlaylistsLayout.prototype.selectTag = function(id) {
      return this.getTag(id).removeClass('tm-tag-info').addClass('tm-tag-success');
    };
    ...
    */
    ...
    PlaylistsLayout.prototype.removeTag = function(e) {
      return this.forgеtTag($(e.currentTarget).prev().find('a').data('id'));
    };
...
(function() {
  var QuotationsLayout,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  Slag.register(QuotationsLayout = (function(_super) {

    __extends(QuotationsLayout, _super);

    function QuotationsLayout() {
      return QuotationsLayout.__super__.constructor.apply(this, arguments);
    }

    QuotationsLayout.prototype.menu_title = 'Цитаты';

    QuotationsLayout.prototype.menu_icon = 'comment';

    return QuotationsLayout;
...
(function() {
  ...
  Slag.register(TagsLayout = (function(_super) {

    __extends(TagsLayout, _super);

    function TagsLayout() {
      return TagsLayout.__super__.constructor.apply(this, arguments);
    }

    TagsLayout.prototype.menu_title = 'Теги';

    TagsLayout.prototype.menu_icon = 'tag';
...
(function() {
  ...
  Slag.register(HomeView = (function(_super) {
    ...
    HomeView.prototype.audit = true;

    HomeView.prototype.menu_title = 'Презентации';

    HomeView.prototype.menu_icon = 'film';

    HomeView.prototype.route = '*path';

    HomeView.prototype.open = function() {
      return console.log("OPEN HOME VIEW", arguments);
    };
...
(function() {
  ...
  Slag.register(notFoundView = (function(_super) {
...
(function() {
  ...
  Slag.register(PlaylistView = (function(_super) {

    __extends(PlaylistView, _super);

    function PlaylistView() {
      this.notFound = __bind(this.notFound, this);

      this.render = __bind(this.render, this);
      return PlaylistView.__super__.constructor.apply(this, arguments);
    }

    PlaylistView.prototype.layout = 'PlaylistLayout';

    PlaylistView.prototype.highlight = 'PlaylistsLayout';

    PlaylistView.prototype.routes = {
      'playlists/edit/:id': 'Редактирование',
      'playlists/new': 'Создание'
    };

    PlaylistView.prototype.menu_icons = {
      'Все': 'globe'
    };

    PlaylistView.prototype.loadmask_css = {
      'min-height': 200
    };

    PlaylistView.prototype.cur_id = null;

    PlaylistView.prototype.audit = true;

    PlaylistView.prototype.include = {
      events: true,
      el_prop: true,
      loader: true
    };

    PlaylistView.prototype.bricks = {};

    PlaylistView.prototype.open = function(action, id) {
      if (action !== 'new') {
        this.loading(true);
        return app.storage.get('playlist', id, {
          done: this.render,
          error: this.notFound
        });
      } else {
        return this.render(new Slag.Models.PlaylistModel);
      }
    };

    PlaylistView.prototype.render = function(model) {
      var content_model, _i, _len, _ref, _results;
      this.model = model;
      this.loading(false);
      ...
      if (this.cur_id !== this.model.id) {
        this.cur_id = this.model.id;
      }
      this.title(this.model.title());
      PlaylistView.__super__.render.apply(this, arguments);
      this.holder = this.$('.contents-holder');
      _ref = this.model.related('content');
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        content_model = _ref[_i];
        _results.push(this.embedContent(content_model));
      }
      return _results;
    };

    PlaylistView.prototype.embedContent = function(content_model) {
      var bid, type, widget;
      type = "" + (content_model.get('content_type')) + "Brick";
      if (!(widget = Slag.Bricks[type])) {
        throw new Error("Brick " + type + " was not found");
      }
      bid = _.uniqueId('brick');
      this.holder.append(Slag.template('views/brick', content_model, {
        bid: bid
      }));
      return this.bricks[content_model.id] = new Slag.Bricks[type]("#" + bid, content_model);
    };

    PlaylistView.prototype.notFound = function() {
      return this.$el.html('NOT FOUND');
    };
...
(function() {
  ...
  Slag.register(PlaylistsView = (function(_super) {
    ...
    PlaylistsView.prototype.layout = 'PlaylistsLayout';

    PlaylistsView.prototype.routes = {
    ...
    PlaylistsView.prototype.menu_icons = {
      'Все': 'globe',
    ...
    */
    ...
    PlaylistsView.prototype.widgets = {};
    ...
    */
    ...
    PlaylistsView.prototype.active = function(model) {
    ...
    */
    ...
    PlaylistsView.prototype.not_active = function(model) {
    ...
    */
    ...
    PlaylistsView.prototype.started = function(model) {
    ...
    */
    ...
    PlaylistsView.prototype.all = function() {
      return true;
    };
    ...
    */
    ...
    PlaylistsView.prototype.eq = function(model, filter) {
      return model.id === parseInt(filter) || ("" + (model.get('title'))).toLowerCase().indexOf(filter.toLowerCase()) >= 0;
    };
    ...
    */
    ...
    PlaylistsView.prototype.initialize = function(el, type, filter) {
      if (filter == null) {
        filter = '';
      }
      PlaylistsView.__super__.initialize.apply(this, arguments);
      this.render({
        type: type
      });
      this.current = null;
      if (!Slag.Widgets.PlaylistsCollectionWidget) {
    ...
    */
    ...
    PlaylistsView.prototype.open = function(type, filter) {
      var collection, condition, id, params,
        _this = this;
      if (filter == null) {
        filter = '';
      }
      ...
      params = params.join("&");
      app.log(params);
      collection = params ? (condition = !filter ? this[type] : function(model) {
        return _this[type](model) && _this.eq(model, filter);
      }, app.storage.getCollection("playlists(?" + params + ")", {
        condition: condition
      })) : app.storage.get('playlists');
      app.log("RESULT", collection);
      if (this.current != null) {
        this.widgets[this.current].hide();
      }
      if (!this.widgets[id]) {
        this.$el.append(Slag.template('views/playlists', {
          id: id
        }));
        this.widgets[id] = new Slag.Widgets.PlaylistsCollectionWidget({
          el: "." + id + "-playlists-collection-widget",
          collection: collection,
          id: id
        });
        this.widgets[id].on('render', function() {
          return _this.widgets[id].$el.find('.badge').tooltip({
            html: true
          });
        });
      }
      this.widgets[id].show();
      this.widgets[id].render();
      this.current = id;
      this.layout.selectTag(this.current);
      return this;
    };
...
(function() {
  ...
  Slag.register(PresentationsView = (function(_super) {
    ...
    PresentationsView.prototype.menu_title = 'Презентации';

    PresentationsView.prototype.menu_icon = 'film';

    PresentationsView.prototype.route = 'presentations(/:id)';

    PresentationsView.prototype.open = function() {
      return console.log("OPEN", arguments);
    };
...
(function() {
  ...
  Slag.register(QuotationsView = (function(_super) {
    ...
    QuotationsView.prototype.layout = 'QuotationsLayout';

    QuotationsView.prototype.routes = {
      'quotations/my': 'Мои цитаты',
      'quotations/all': 'Все цитаты'
    };

    QuotationsView.prototype.menu_icons = {
      'Все цитаты': 'asterisk',
      'Мои цитаты': 'star-empty'
    };

    QuotationsView.prototype.my = function() {};

    QuotationsView.prototype.initialize = function(el, type, filter) {
      var collection;
      QuotationsView.__super__.initialize.apply(this, arguments);
      this.render({
        type: type
      });
      collection = type !== 'all' ? app.storage.getCollection("quotations(/my)", {
        condition: this[type]
      }) : app.storage.get('quotations');
      return this.collectionWidget = Slag.factory('CollectionWidget', {
        fname: 'QuotationsCollectionWidget',
        protected_methods: ['handleScroll']
      }, {
    ...
    QuotationsView.prototype.open = function(type, filter) {
      return this.collectionWidget.render();
    };
...
(function() {
  ...
  Slag.register(LangInput = (function(_super) {

    __extends(LangInput, _super);

    LangInput.prototype.langs = null;

    LangInput.prototype.options = {
      all: true
    };

    LangInput.prototype.audit = true;

    LangInput.prototype.events = function() {
      return {
        'click .btn': this.change
      };
    };
    ...
    function LangInput() {
      ...
      var _ref, _ref1,
        _this = this;
      LangInput.__super__.constructor.apply(this, arguments);
      if ((_ref = this.langs) == null) {
        this.langs = app.storage.factory('langs');
      }
      if ((_ref1 = this.input) == null) {
        this.input = this.$el;
      }
      this.setEl(this.input.parent());
      this.once('render', function() {
        console.log("HERE");
        return _this.model.on('change:lang', function(m) {
          return this.setValue(m.get('lang'));
        });
      });
      this.on('render', function() {
        if (!_this.checkAvailability()) {
    ...
    LangInput.prototype.change = function(e) {
      console.log(this);
      return console.log("CHANGE", this.model.id, this.val());
    };

    LangInput.prototype.getValue = function() {
      return this.$('.active > input').val() || this.input.val();
    };

    LangInput.prototype.setValue = function(value) {
      this.$('.label').removeClass('active');
      this.$("input[value=\"" + value + "\"]").parent().addClass('active');
      return this.input.val(value);
    };

    LangInput.prototype.render = function() {
      return this.input.after(Slag.template('widgets/lang', {
        langs: this.langs.toJSON(),
        active: this.model.get('attrs.lang'),
        translations: this.model.translations
      }));
    };

    LangInput.prototype.checkAvailability = function() {
      return this.model.get('attrs.lang') !== void 0;
    };

    LangInput.prototype.disable = function() {
      return this.$('.btn').attr('disabled', true);
    };

    LangInput.prototype.enable = function() {
...
(function() {
  ...
  Slag.register(CollectionWidget = (function(_super) {

    __extends(CollectionWidget, _super);
    ...
    function CollectionWidget() {
      ...
      this.prepareToUpdate = __bind(this.prepareToUpdate, this);

      this.initChangesHandeling = __bind(this.initChangesHandeling, this);
      return CollectionWidget.__super__.constructor.apply(this, arguments);
    }

    CollectionWidget.prototype.include = {
      events: true,
      el_prop: true,
      loader: true
    };

    CollectionWidget.prototype.defaults = {
      collection: false,
      entity: false,
      auto_render: true,
      scroll: true,
    ...
    CollectionWidget.prototype.handeling = false;

    CollectionWidget.prototype.initialize = function(options) {
      if (options == null) {
        options = {};
      }
      ...
      _.extend(this, options);
      this.entity = this.collection.getEntityName();
      this.ids = [];
      this.setEl(options.el || ("." + this.entity + "-collection-widget"));
      this.$el.after("<div class='loadmask'></div><div class='noop'>" + this.empty_text + "</div>");
      this.loadmask = this.$el.next();
      this.noop = this.loadmask.next();
      if (this.collection.getModels().length < this.options.min) {
        this.more();
      } else {
        this.render();
      }
      ...
      Slag.on("" + this.collection.model.name + ".change", this.updateRow);
      return Slag.on("" + this.collection.model.name + ".removeRow", this.removeRow);
    };

    CollectionWidget.prototype.initChangesHandeling = function() {
      this.collection.on("add", this.prepareToUpdate);
      this.collection.on("sync", this.prepareToUpdate);
      return this.handeling = true;
    };

    CollectionWidget.prototype.prepareToUpdate = function() {
      if (!this.loading(this.loadmask)) {
        return _.throttle(this.update, 500);
      }
    };

    CollectionWidget.prototype.get = function(model) {
      return this.$("." + this.entity + "-" + (model.id || model));
    };

    CollectionWidget.prototype.render = function(force) {
      if (force == null) {
        force = false;
      }
      if (!this.collection.getModels().length && !force) {
        if (!this.loading(this.loadmask)) {
          this.more();
        }
        return false;
    ...
    CollectionWidget.prototype.update = function(models) {
      var id, model, _i, _j, _len, _len1, _ref, _ref1;
      if (models == null) {
      ...
      _ref = _.difference(this.ids, models.pluck('id'));
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        id = _ref[_i];
        this.removeRow({
          id: id
      ...
      this.loading(this.loadmask, false);
      if (models.length) {
        this.noop.hide();
        _ref1 = this.collection.getModels();
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          model = _ref1[_j];
          this.add(model);
        }
      } else {
        this.noop.fadeIn(200);
      }
      return models;
    };

    CollectionWidget.prototype.more = function() {
      var dfd,
        _this = this;
      this.loading(this.loadmask, true);
      console.log("COLLECTION", this.collection);
      dfd = app.storage.more(this.collection, {}, function() {
        if (!_this.handeling) {
          _this.initChangesHandeling();
        }
        return _this.render(true);
      });
      if (!dfd) {
        return this.loading(this.loadmask, false);
      }
    };

    CollectionWidget.prototype.template = function(model) {
      var el;
      el = Slag.template("collections/" + this.entity, model);
      return $(el).addClass("" + this.entity + "-" + model.id + " " + this.entity + "-collection-item");
    };

    CollectionWidget.prototype.embedRow = function(model, method) {
      if (method == null) {
        method = 'append';
      }
      this.template(model).data('model', model)["" + method + "To"](this.el);
      return this.highlight(model);
    };

    CollectionWidget.prototype.updateRow = function(model) {
      var el;
      if ((el = this.get(model)) && el.length) {
        this.get(model).replaceWith(this.template(model));
        return this.highlight(model);
      }
    };

    CollectionWidget.prototype.removeRow = function(model) {
      var el,
        _this = this;
      if ((el = this.get(model)) && el.length) {
        this.models = _.without(this.models, model);
        return this.invoke(model, 'hide', 'highlight', {
          color: "#FFDBDB",
          complete: function() {
            return _this.invoke(model, 'removeRow');
          }
        });
      }
    };

    CollectionWidget.prototype.appendRow = function(model) {
      return this.embedRow(model);
    };

    CollectionWidget.prototype.highlight = function(model) {
      return this.get(model).hide().show('highlight', {
        color: "#DBEDFF"
      });
    };

    CollectionWidget.prototype.prepend = function(model) {
      return this.embedRow(model, 'prepend');
    };

    CollectionWidget.prototype.add = function(model) {
      if (_.indexOf(this.ids, model.id) < 0) {
        this.ids.push(model.id);
        return this.appendRow(model);
      }
    };

    CollectionWidget.prototype.hide = function() {
      this.$el.hide();
      this.noop.hide();
      return this.loadmask.hide();
    };

    CollectionWidget.prototype.show = function() {
      this.$el.show();
      if (this.loading()) {
        return this.loadmask.show();
      } else {
        if (this.ids.length === 0 && this.loading(this.loadmask) === false) {
          return this.noop.show();
        }
      }
    };

    CollectionWidget.prototype.invoke = function() {
      var action, model, options, _ref;
      model = arguments[0], action = arguments[1], options = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
      return (_ref = this.get(model))[action].apply(_ref, options);
    };

    CollectionWidget.prototype.handleScroll = function() {
      var w;
      if (!this.$el.is(":visible") || this.loading(this.loadmask) || this.collection.isFullyLoaded()) {
        return;
      }
      w = $(window);
      if (this.$el.height() + this.$el.offset().top - w.scrollTop() - w.height() < w.height() / 3) {
        return this.more();
      }
    };
...
(function() {
  var ContentTypesWidget,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  Slag.register(ContentTypesWidget = (function(_super) {

    __extends(ContentTypesWidget, _super);

    ContentTypesWidget.prototype.types = {};

    function ContentTypesWidget(el) {
      ContentTypesWidget.__super__.constructor.apply(this, arguments);
      this.setEl(el);
      if (!_.size(this.types)) {
        this.types = _.map(Slag.Contents, function(c) {
          return _.pick(c.prototype, 'badge', 'icon', 'title');
        });
      }
      this.render();
    }

    ContentTypesWidget.prototype.render = function() {
      var type, _i, _len, _ref;
      _ref = this.types;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        type = _ref[_i];
        this.$el.append(this.template('label', type));
      }
      return this.$('.badge').tooltip();
    };

    ContentTypesWidget.prototype.template = function(tmp, data) {
      return Slag.template("widgets/content_" + tmp, data);
    };

    return ContentTypesWidget;
